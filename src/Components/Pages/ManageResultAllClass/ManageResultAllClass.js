		...
		<div data-aos='fade-left' className='p-5'>
			...
			<section class="hero-section p-0">
				<div class="card-grid-ManageUsersByClass">
					...
					<button className="card-blur-class bg-transparent" onClick={() => goTomanage({ className: "9", batch: "bangla", group: "commerce" })}>
						<div class="card__background"></div>
						<div class="card__content d-flex flex-column">
							<h3 class="card__heading">Class 9 Bangla Commerce</h3>
						</div>
					</button>
					<button className="card-blur-class bg-transparent" onClick={() => goTomanage({ className: "9", batch: "english", group: "commerce" })}>
						<div class="card__background"></div>
						<div class="card__content d-flex flex-column">
					...
					<button className="card-blur-class bg-transparent" onClick={() => goTomanage({ className: "10", batch: "bangla", group: "commerce" })}>
						<div class="card__background"></div>
						<div class="card__content d-flex flex-column">
							<h3 class="card__heading">Class 10 Bangla Commerce</h3>
						</div>
					</button>
					<button className="card-blur-class bg-transparent" onClick={() => goTomanage({ className: "10", batch: "english", group: "commerce" })}>
						<div class="card__background"></div>
						<div class="card__content d-flex flex-column">
