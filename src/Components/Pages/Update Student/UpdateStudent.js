...
const UpdateStudent = () => {
    ...
    const EventSubmit = (event) => {
        ...
        const updatedUser = { name, father, mother, className, batch, group, img: student[0]?.img, paid: student[0]?.paid, lastPaid: student[0]?.lastPaid, due: student[0]?.due, payMonth: student[0]?.payMonth };
